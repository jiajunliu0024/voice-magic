...
export default function Home() {
  ...
  const [numberOfBar, setNumberOfBar] = useState(60);
  ...
  useEffect(() => {
    width.width > 1024 ? setNumberOfBar(60) : setNumberOfBar(20);
  }, [width]);

  return (
    <div className="h-screen w-full bg-gradient-to-b from-purple-100 to-blue-100">
      <div className="pt-40 h-full w-full flex flex-col justify-start items-start">
